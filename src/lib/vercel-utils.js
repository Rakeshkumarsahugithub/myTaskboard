...
/**
 * Ensures the /tmp directory exists and is writable on Vercel
 * This should be called before any file operations in the API routes
 */
...
/**
 * Checks if the application is running in a Vercel production environment
 */
